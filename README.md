...
1. **Hero** — Name, title, brief intro, key skills
2. **Skills** — Testing, Documentation, Tools, Web Basics
3. **Projects** — 2 project showcases with artifacts
4. **Bug Reports** — Sample bug report with full details
5. **Certificates** — Learning achievements + ISTQB status
